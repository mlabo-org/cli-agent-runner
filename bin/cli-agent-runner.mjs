...
function prepareRunnerExecution(commandContext, packet, args) {
  ...
  return { ...configured, runner, timeoutMs, scopePrefixes };
}
...
function runConfiguredCli(commandContext, packet, options) {
...
Commands:
  ...
  run/orchestrate
           Record an assignment and orchestration skeleton by default; with --runner <id>, resolve the configured CLI profile, spawn it, and record normalized results.
  verify-assignments
