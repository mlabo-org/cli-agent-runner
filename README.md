...
CLI Agent Runner launches scoped Codex, Claude, Grok, or JSON-configured command-line workers. An exit-zero in-scope run records one minimal completed result and stops; failure and scope violations remain explicit.
