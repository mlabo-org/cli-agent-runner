...
export const RUNNER_CONFIG_FILE = "runners.json";
...
function runnerConfigCandidates({ invocationCwd, environment, explicitConfigPath }) {
  const candidates = [{
  ...
  candidates.push({
    label: "user config",
    path: path.join(configHome, "cli-agent-runner", RUNNER_CONFIG_FILE),
    required: false,
  });
